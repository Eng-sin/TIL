  ...
  <div class="regist">
    <form class="regist__form" method="post">
        ...
        <select name="task_status" value=<?php echo $taskStatus?>>
          <option>選択してください</option>
          <option <?php if ( $_POST['task_status'] === '未着手' ) { echo ' selected'; } ?> value="未着手">未着手</option>
          <option <?php if ( $_POST['task_status'] === '進行中' ) { echo ' selected'; } ?> value="進行中">進行中</option>
          <option <?php if ( $_POST['task_status'] === '完了' ) { echo ' selected'; } ?> value="完了">完了</option>
        </select> 
        </div>
        <div class="regist__form__item">
        <p>優先度：</p>
        <select name="priority" value=<?php echo $priority?>>
          <option>選択してください</option>
          <option <?php if ( $_POST['priority'] === '高' ) { echo ' selected'; } ?> value="高">高</option>
          <option <?php if ( $_POST['priority'] === '中' ) { echo ' selected'; } ?> value="中">中</option>
          <option <?php if ( $_POST['priority'] === '低' ) { echo ' selected'; } ?> value="低">低</option>
        </select> 
        </div>
